	    ...
	    describe('Collections', function () {
	      ...
	      describe('Feeds', function () {
	        ...
	        it('Feeds collection should be created', function () {
	          chai.expect(FeedMe.Feeds).to.not.equal(undefined);
	          chai.expect(FeedMe.Feeds instanceof Mongo.Collection)
              .to.equal(true);
	        });
					...
					describe('Schema', function () {
						...
						it('Feed name should be mandatory', function () {
							this.feed.name = null;
							FeedMe.Feeds.insert(this.feed, function (error, result) {
          ...
          describe('#authorizedFeedIds', function () {
            ...
            it('should return an empty array if not logged in', function () {
              var feedIds = FeedMe.Feeds.authorizedFeedIds();
